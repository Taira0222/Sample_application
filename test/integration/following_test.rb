...
class FollowPagesTest <Following
  ...
  test "following page"do
    ...
    assert_not @user.following.empty? # @user.following.each do |user|の部分がテストされずにスルーするのを防ぐため
  ...
  test "followers page"do
    ...
    assert_response :success
    assert_not @user.followers.empty? # @user.followers.each do |user|の部分がテストされずにスルーするのを防ぐため
